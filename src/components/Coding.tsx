      ...
      <div className="container-max">
        <div className="section-container section-skills">
          ...
          <div className="text-center mb-12 md:mb-16">
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-6 gradient-text leading-tight py-2">
          ...
          <div className="block md:hidden">
            ...
            <div className="mb-8">
              <h3 className="text-lg font-semibold text-center text-white mb-6 flex items-center justify-center gap-2">
                <span className="text-2xl">📊</span>
                Achievement Overview
              </h3>
              <div className="grid grid-cols-2 gap-4">
                {overallStats.map((stat, index) => (
                  <div key={index} className="glow-card text-center p-4">
              ...
              <div className="space-y-4">
                {competitivePlatforms.map((platform, index) => (
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="glow-card block p-4 cursor-pointer"
                  >
                    {/* Mobile Platform Header */}
                    <div className="flex items-center justify-between mb-3">
                      <div className="flex items-center gap-3">
                        <div className={`w-10 h-10 rounded-lg ${platform.bgColor} flex items-center justify-center p-2`}>
                          <Image 
                            src={platform.icon} 
                            alt={platform.name} 
                            width={28} 
                        ...
                        <div>
                          ...
                          <p className="text-xs text-slate-400">{platform.achievement}</p>
                        </div>
                      </div>
                      <div className={`text-xl font-bold bg-gradient-to-r ${platform.color} bg-clip-text text-transparent`}>
                        {platform.peakRating}
                      </div>
                    </div>
                 ...
                 {typingPlatforms.map((platform, index) => (
                   ...
                   >
                     <div className="flex items-start gap-3">
                       <div className={`w-10 h-10 rounded-lg ${platform.bgColor} flex items-center justify-center flex-shrink-0 p-2`}>
                         <Image 
                           src={platform.icon} 
                           alt={platform.name} 
                           width={24} 
                       ...
                       <div className="text-right flex-shrink-0">
                         {platform.achievement === "Top 5% Globally" ? (
                           <>
                             <div className="text-sm font-bold bg-gradient-to-r from-indigo-500 to-indigo-600 bg-clip-text text-transparent">
                               Top 5%
                             </div>
                           ...
                           <>
                             <div className="text-sm font-bold bg-gradient-to-r from-purple-500 to-purple-600 bg-clip-text text-transparent">
                               High
                             </div>
                             <div className="text-xs text-slate-400">
                               Accuracy
